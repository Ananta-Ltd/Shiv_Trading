    ...
    <div className="mt-10 ">
      <div className=" relative">
        <div className=" md:mx-24 relative">
          ...
          <Image src={about} alt="about" className="h-[300px] w-[100xw] md:w-[90vw] bg-black object-cover" />
          <Link href={`${process.env.NEXT_PUBLIC_clientLocationUrl}`} target="_blank" rel="noopener noreferrer">
      ...
      <div className='flex flex-col justify-center items-center '>
        ...
        <div className='flex justify-center items-center text-gray-500 text-[18px] mt-1'>
          ...
          <Link href="https://www.facebook.com/search/top?q=shiv%20trading%20tiles%2C%20marbles%20and%20sanitary" target="_blank" rel="noopener noreferrer" className="text-[#000088] hover:text-indigo-500 ml-2">
